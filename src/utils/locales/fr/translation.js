  ...
  fr: {
    translation: {
      ...
      "education.details.brac":
        "Solide formation en algorithmes, génie logiciel et systèmes infonuagiques, avec un projet de recherche en apprentissage automatique sur les systèmes de recommandation personnalisés.",
      ...
      "education.details.concordia":
        "Spécialisée en sécurité des systèmes d'exploitation, architecture de sécurité réseau, défense contre les malwares et intégration sécurisée des systèmes.",
      ...
      "experience.desc.bevy":
        "Direction de l'initiative de refonte de l'interface. Amélioration des performances de 40% grâce au fractionnement de code et à l'optimisation des ressources. Mentorat de développeurs junior.",
      "experience.bevy.resp1":
        "Dirigé les projets de refonte UI/UX pour les plateformes e-commerce utilisant React et Next.js",
      "experience.bevy.resp2":
        "Implémenté des optimisations de performance incluant le fractionnement de code et le chargement paresseux",
      "experience.bevy.resp3":
        "Collaboré avec les équipes backend pour intégrer les APIs Shopify et solutions personnalisées",
      "experience.bevy.resp4":
        "Mentoré les développeurs juniors et effectué des revues de code",
      "experience.bevy.achievement1":
        "Amélioré le temps de chargement du site de 40% grâce à l'optimisation des ressources et au fractionnement de code",
      "experience.bevy.achievement2":
        "Lancé avec succès plus de 5 projets clients dans les délais sans bugs critiques",
      "experience.bevy.achievement3":
        "Implémenté des modèles de conception adaptative augmentant la conversion mobile de 25%",
      ...
      "experience.desc.technest":
        "Création de sites web adaptatifs pour plus de 100 clients. Collaboration étroite avec les designers pour implémenter des animations au pixel près.",
      "experience.technest.resp1":
        "Développer et maintenir des applications web adaptatives utilisant Next.js",
      "experience.technest.resp2":
        "Créer des composants UI accessibles et performants suivant les directives WCAG",
      "experience.technest.resp3":
        "Implémenter des animations et interactions complexes utilisant GSAP",
      "experience.technest.resp4":
        "Intégrer l'API Google Sheets et solutions CMS personnalisées pour la gestion de contenu",
      "experience.technest.achievement1":
        "Construit et déployé plus de 100 sites web clients avec un taux de satisfaction de 100%",
      "experience.technest.achievement2":
        "Implémenté des fonctionnalités d'accessibilité atteignant la conformité WCAG 2.1 AA",
      "experience.technest.achievement3":
        "Créé une bibliothèque de composants réutilisables réduisant le temps de développement de 30%",
      ...
      "additionalExperience.role.customerService":
        "Représentant du Service Client - Rogers & Fido",
      ...
      "additionalExperience.role.gradAmbassador":
        "Ambassadeur des Étudiants Diplômés",
      "additionalExperience.company.gradStudies":
        "École des Études Supérieures, Université Concordia",
      ...
      "additionalExperience.company.examOffice":
        "Bureau des Examens, Université Concordia",
      ...
      "projects.bdgsa.problem":
        "Les organisations étudiantes ont du mal à maintenir des sites web dynamiques sans nécessiter une implication constante des développeurs.",
      "projects.bdgsa.idea":
        "Créer une plateforme de blog et de contenu évolutive avec gestion basée sur les rôles et workflows de modération.",
      "projects.bdgsa.solution":
        "Une plateforme Next.js full-stack avec tableaux de bord d'administration, authentification JWT, et workflows de soumission de contenu modéré.",
      ...
      "projects.technest.problem":
        "Les équipes non-techniques doivent gérer les événements et podcasts sans dépendance aux développeurs.",
      "projects.technest.idea":
        "Fournir une plateforme pilotée par tableau de bord permettant aux non-développeurs de mettre à jour le contenu du site via des outils simples.",
      "projects.technest.solution":
        "Une plateforme Next.js + TypeScript en production intégrée avec Google Sheets et un tableau de bord d'administration pour gérer les événements, podcasts et données d'équipe.",
      ...
      "projects.containerguard.problem":
        "Les applications conteneurisées sont vulnérables aux attaques en raison de configurations faibles et d'isolation inappropriée.",
      "projects.containerguard.idea":
        "Analyser et renforcer les environnements de conteneurs en appliquant les meilleures pratiques de sécurité de conteneurs modernes.",
      "projects.containerguard.solution":
        "Une implémentation axée sur la sécurité utilisant des environnements Docker pour tester les vulnérabilités et implémenter l'isolation, les contrôles de privilèges, et les défenses d'attaque.",
      ...
      "projects.malwaredefense.title":
        "Analyse et Défense Automatisée contre les Malwares",
      "projects.malwaredefense.problem":
        "Les systèmes logiciels hérités restent vulnérables en raison de vulnérabilités non détectées et de défenses obsolètes.",
      "projects.malwaredefense.idea":
        "Automatiser la détection de vulnérabilités de malwares et renforcer les mécanismes de défense en utilisant des outils d'ingénierie inverse.",
      "projects.malwaredefense.solution":
        "Ingénierie inverse d'exécutables avec Ghidra et développement de scripts Python pour automatiser la détection et l'atténuation des vulnérabilités.",
      "projects.malwaredefense.longDescription":
        "Ce projet impliquait l'ingénierie inverse d'exécutables utilisant Ghidra pour identifier les failles de sécurité telles que les identifiants codés en dur et les débordements de tampon. Des scripts Python automatisés ont été développés pour améliorer la détection de vulnérabilités et les implémentations de défense, améliorant la résilience des logiciels hérités.",

      "projects.mealrecommender.title":
        "Système de Recommandation de Repas Basé sur les Émotions",
      "projects.mealrecommender.problem":
        "Les systèmes traditionnels de recommandation de repas ignorent les réponses émotionnelles influençant les choix alimentaires.",
      "projects.mealrecommender.idea":
        "Utiliser les données EEG pour personnaliser les recommandations de repas basées sur les réactions émotionnelles.",
      "projects.mealrecommender.solution":
        "Un système d'apprentissage automatique analysant les signaux EEG et appliquant plusieurs algorithmes ML pour recommander des repas alignés avec les réponses émotionnelles.",
      "projects.mealrecommender.longDescription":
        "Le système analysait les signaux EEG de participants pour comprendre les réactions émotionnelles envers la nourriture et recommander des repas en conséquence. Plusieurs algorithmes ML incluant Random Forest, KNN, SVM, et XGBoost ont été utilisés pour valider les recommandations de repas personnalisées.",

      "projects.dllinjection.title":
        "Détection d'Injection de DLL Malveillantes utilisant Ghidra",
      "projects.dllinjection.problem":
        "Les injections de DLL malveillantes permettent aux attaquants d'exécuter du code non autorisé dans des processus légitimes, rendant la détection difficile dans de grands ensembles de données binaires.",
      "projects.dllinjection.idea":
        "Utiliser des techniques d'analyse de code statique pour détecter automatiquement les appels API suspects et les modèles d'injection dans les binaires.",
      "projects.dllinjection.solution":
        "Un framework d'analyse statique basé sur Ghidra enrichi de scripts d'automatisation Python pour détecter les modèles d'injection suspects et réduire les faux positifs.",
      "projects.dllinjection.longDescription":
        "Ce projet a implémenté un framework d'analyse statique utilisant Ghidra pour détecter les tentatives d'injection de DLL malveillantes dans les binaires compilés. Les scripts Python ont automatisé l'identification d'appels API suspects tels que VirtualAllocEx et WriteProcessMemory. Le système a analysé 39 binaires et atteint 97% de précision de détection avec un F1-score de 0,89 tout en améliorant la fiabilité grâce à une correspondance de motifs raffinée et une réduction des faux positifs. Le projet a renforcé l'expertise dans les workflows d'ingénierie inverse et les pipelines d'analyse automatisée de malwares.",

      "projects.marvelhangman.title": "Jeu du Pendu Marvel",
      "projects.marvelhangman.problem":
        "Les jeux de devinettes classiques sont souvent génériques et manquent de thèmes engageants pour les fans.",
      "projects.marvelhangman.idea":
        "Créer un jeu du pendu thématique où les joueurs devinent les noms de personnages Marvel de manière amusante et interactive.",
      "projects.marvelhangman.solution":
        "Un jeu du pendu basé sur navigateur construit avec Vanilla JavaScript, HTML et CSS, permettant aux utilisateurs de deviner les noms de personnages Marvel avec des commentaires interactifs.",
      ...
      "features.characterNameGuessing":
        "Deviner les noms de personnages Marvel lettre par lettre",
      "features.dynamicWordRendering": "Rendu dynamique des mots et lettres",
      "features.gameStateManagement":
        "Gestion interactive de l'état du jeu et commentaires",
      ...
      "features.adminDashboard":
        "Tableau de bord d'administration avec gestion de contenu",
      "features.mobileResponsive": "Conception UI réactive mobile-first",
      "features.restApiIntegration":
        "Gestion de contenu dynamique alimentée par API REST",
      "features.dashboardRealtimeUpdates":
        "Mises à jour de tableau de bord reflétées sur le site en temps réel",
      "features.googleSheetsIntegration":
        "Mises à jour de contenu alimentées par Google Sheets",
      "features.apiCaching":
        "Mise en cache API et mémorisation pour amélioration des performances",
      "features.globalStateManagement":
        "Gestion d'état global entre le tableau de bord et les pages publiques",

      "features.containerIsolation":
        "Isolation de conteneurs et accès aux privilèges minimums",
      "features.attackSimulation":
        "Tests de sécurité contre injection SQL, inondation SYN, et XSS",
      "features.readOnlyFilesystem":
        "Protections de système de fichiers de conteneur en lecture seule",

      "features.reverseEngineering":
        "Ingénierie inverse d'exécutables utilisant Ghidra",
      "features.vulnerabilityAutomation":
        "Détection automatisée de vulnérabilités via scripts Python",
      "features.legacyDefense":
        "Améliorations de défense pour systèmes hérités",

      "features.eegAnalysis":
        "Traitement de signaux EEG pour analyse d'émotions",
      "features.mlPrediction":
        "Modèles de recommandation basés sur l'apprentissage automatique",
      "features.personalizedSuggestions":
        "Suggestions de repas personnalisées basées sur les émotions",

      "features.staticBinaryAnalysis":
        "Analyse binaire statique utilisant Ghidra",
      "features.apiDetectionAutomation":
        "Détection automatisée d'appels API suspects via scripts Python",
      "features.patternMatchingEngine":
        "Moteur de correspondance de motifs précis pour réduire les faux positifs",
      "features.datasetAnalysis":
        "Analyse d'ensembles de données binaires à grande échelle",
      "features.reverseEngineeringWorkflow":
        "Automatisation des workflows d'ingénierie inverse et d'analyse de malwares",

      // Voluntary
      "voluntary.bdgsavp.role": "Vice-Présidente aux Communications",
      "voluntary.bdgsavp.org":
        "Association des Étudiants Diplômés du Bangladesh, Université Concordia",
      "voluntary.bdgsavp.desc":
        "Dirigé les initiatives de communication et coordonné les activités de sensibilisation pour renforcer l'engagement parmi les étudiants diplômés et promouvoir les événements et programmes de l'association.",
      ...
      "voluntary.bracclubhr.desc":
        "Soutenu le recrutement, la coordination des membres et les opérations internes tout en aidant à organiser les activités et événements du club pour les étudiants intéressés par la technologie et l'informatique.",
      ...
      "voluntary.bracadventureit.desc":
        "Fourni un support technique et géré les ressources numériques et communications pour aider à organiser des événements et activités pour les membres du club.",

      // Additional
      "additional.speaking": "Prise de parole publique : TechConf 2023",
      "additional.writing":
        "Rédaction technique : Blog Medium avec plus de 5k lecteurs",
      ...
      "hero.subtitle":
        "Ingénieur Frontend spécialisé en React, interactions créatives et interfaces pixel-parfait.",
      ...
      "hero.name": "Nom :",
      "hero.nameValue": "Fatema Ahsan Meem",
      "hero.level": "Niveau :",
      ...
      "projects.subtitle":
        "Sélectionnez un numéro pour lire l'histoire complète.",
      ...
      "projectModal.requestDemo": "Demander une Démo",
      ...
      "contact.quote":
        "La vie est comme un site web. Il faut juste continuer à refactoriser jusqu'à ce que ça marche.",
      ...
      "footer.designedWith":
        "Conçu avec ❤️ et ☕️. Aucun personnage protégé par des droits d'auteur n'a été blessé lors de la création de ce site.",
