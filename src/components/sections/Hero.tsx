    ...
    <section id="about" className="min-h-screen pt-28 pb-16 px-4 md:px-8 flex flex-col justify-center bg-comic-paper dark:bg-comic-dark-bg">
      <div className="relative z-10 max-w-6xl mx-auto w-full grid md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-7 space-y-8">
           {/* Speech Bubble Intro */}
            ...
            <h1 className="font-comic font-bold text-5xl md:text-7xl leading-tight dark:text-comic-paper text-comic-black">
              I Build <span className="relative inline-block dark:text-comic-paper text-comic-black">
                <span className="relative z-10 text-comic-yellow dark:text-comic-paper">Websites</span>
        ...
        <div className="md:col-span-5 relative">
          <ComicPanel title="The Protagonist" className="transform rotate-2 hover:rotate-0 transition-transform duration-300 z-20">
            ...
            <div className="mt-4 font-body text-sm space-y-2 text-comic-black dark:text-comic-paper">
              <p><strong>Name:</strong> Fatema A. Meem</p>
              <p><strong>Level:</strong> Frontend Engineer</p>
              <p><strong>Superpower:</strong> Converting coffee into clean code.</p>
            </div>
          </ComicPanel>
